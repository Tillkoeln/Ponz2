...
const string strMessageMagic = "Ponz2 Signed Message:\n";
...
{  
	...
	//Day 2
	else if(pindexBest->nHeight > 240)
    {
        nSubsidy = 1 * COIN; 
		return nSubsidy + nFees; 
    }
    ...
    // Additional Blocks missing Prefork
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Ponz2", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
